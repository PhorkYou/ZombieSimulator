...
namespace Zombie_Sim
{
    ...
    {
        public const int DrawWidth = 24;
        public int SpotDistance = ApplicationContext.Instance.Game.SpotDistance;
        protected static UInt64 IDC= 0;

        protected Color DrawColor;
        protected Color EraseColor = ApplicationContext.Instance.Game.Background;
        ...
        public void Draw(bool erase)
        {
            ...
            {
                //2014/12/12: I use images instead of colored squares.
                //J'utilise des images au lieu de carrés colorés.
